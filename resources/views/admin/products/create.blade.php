                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" id="basiInput" name="sku" value="{{strtoupper(\Str::random(8))}}">
                                    </div>
                                </div>
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="number" class="form-control" id="basiInput" name="sale_price">
                                    </div>
                                </div>
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <textarea name="material" class="form-control" id="" cols="30" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        <label for="basiInput" class="form-label">Hướng dẫn sử dụng</label>
                                        <textarea name="user_manual" class="form-control" id="" cols="30" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                    ...
                                    <div class="col-xxl-2 col-md-2">
                                        <div>
                                            ...
                                            <div class="form-check form-check-outline form-check-primary mb-3">
                                                <input class="form-check-input" type="checkbox" id="formCheck13" name="is_active" value="1" checked>
                                    ...
                                    <div class="col-xxl-2 col-md-2">
                                        <div>
                                            ...
                                            <div class="form-check form-check-outline form-check-info mb-3">
                                                <input class="form-check-input" type="checkbox" id="formCheck13" name="is_hot_deal" value="1" checked>
                                                <label class="form-check-label" for="formCheck13">
                                                    Is hot deal
                                                </label>
                                            </div>
                                    ...
                                    <div class="col-xxl-2 col-md-2">
                                        <div>
                                            ...
                                            <div class="form-check form-check-outline form-check-warning mb-3">
                                                <input class="form-check-input" type="checkbox" id="formCheck13" name="is_good_deal" value="1" checked>
                                                <label class="form-check-label" for="formCheck13">
                                                    Is good deal
                                                </label>
                                            </div>
                                    ...
                                    <div class="col-xxl-2 col-md-2">
                                        <div>
                                            ...
                                            <div class="form-check form-check-outline form-check-success mb-3">
                                                <input class="form-check-input" type="checkbox" id="formCheck13" name="is_new" value="1" checked>
                                                <label class="form-check-label" for="formCheck13">
                                                    Is new
                                                </label>
                                            </div>
                                    ...
                                    <div class="col-xxl-2 col-md-2">
                                        <div>
                                            ...
                                            <div class="form-check form-check-outline form-check-danger mb-3">
                                                <input class="form-check-input" type="checkbox" id="formCheck13" name="is_show_home" value="1" checked>
                                                <label class="form-check-label" for="formCheck13">
                                                    Is show home
                                                </label>
                                            </div>
